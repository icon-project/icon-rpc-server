...
rm -rf earlgrey*
wget "http://tbears.icon.foundation.s3-website.ap-northeast-2.amazonaws.com/iconcommons-0.9.4-py3-none-any.whl"
pip install --force-reinstall iconcommons-0.9.4-py3-none-any.whl
rm -rf iconcommons*
